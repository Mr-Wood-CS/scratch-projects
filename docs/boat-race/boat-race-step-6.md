...
![Boat booster arrows](assets/boat-boost.png)
...
![Gate sprite](assets/boat-gate.png)

Make sure that the colour of the gate sprite is the same as the colour of the wooden barriers.

![Brown HSV settings](assets/brown-hsv.png)
...
![Gate centre position](assets/boat-center.png)
...
![Boat gate test](assets/boat-gate-test.png){ width="360" }
