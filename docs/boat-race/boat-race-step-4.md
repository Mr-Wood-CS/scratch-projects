...
![Winning condition Scratch blocks](assets/boat-block-05-winning-condition.png){ width="70%" }
...
!!! warning "**Before you go any further, test your code.**"
    ...
    ![Test start position Scratch blocks](assets/boat-block-06-test-start-position.png){ width="70%" }
